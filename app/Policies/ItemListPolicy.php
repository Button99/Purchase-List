...
class ItemListPolicy
{
     ...
     */
    public function viewAny(User $user, ItemList $itemList)
    {
        //
    }
    ...
    {
        return $user->id === $itemList->user_id || $user->isAdmin === true || $itemList->public === true;
    }
    ...
    {
        return $user->id === $itemList->user_id || $user->isAdmin === true;
    }
